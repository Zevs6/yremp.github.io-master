		...
		*/
		...
		r.prototype.init = function(e) {
			...
			try {
				var n = e.lang || "",
					...
					l = e.avatarForce,
					c = e.avatar_cdn || "";
				n && r && t.installLocale(n, r), t.locale = t.locale || v[e.lang || "zh-cn"], t.notify = e.notify || !1, t.verify =
					e.verify || !1;
				var d = l ? "&q=" + Math.random().toString(32).substring(2) : "";
				g.params = "?d=" + (i.indexOf(a) > -1 ? a : "mp") + "&v=" + o + d, g.hide = "hide" === a, g.cdn = !!c && c ||
					g.cdn, x = e.path || x;
				...
				AV.applicationId && delete AV._config.applicationId || (AV.applicationId = null), AV.applicationKey && delete AV
					._config.applicationKey || (AV.applicationKey = null), AV.init({
						appId: h,
						appKey: b,
						region: y
					});
				...
				t.el = S, t.el.classList.add("v"), g.hide && t.el.classList.add("hide-avatar"), e.meta = (e.guest_info || e.meta ||
					m).filter(function(e) {
					return m.indexOf(e) > -1
				});
				var E = (0 == e.meta.length ? m : e.meta).map(function(e) {
					var n = "mail" == e ? "email" : "text";
					return m.indexOf(e) > -1 ? '<input name="' + e + '" placeholder="' + t.locale.head[e] + '" class="v' + e +
						' vinput" type="' + n + '">' : ""
				});
				t.placeholder = e.placeholder || "Just Go Go", t.el.innerHTML = '<div class="vwrap"><div class="vheader item' +
					E.length + '">' + E.join("") +
					'</div><div class="vedit"><textarea id="veditor" class="veditor vinput" placeholder="' + t.placeholder +
				...
				t.alert = {
					show: function(e) {
						T.innerHTML = '<div class="valert txt-center"><div class="vtext">' + (e && e.text || 1) +
					...
					if (n.length) {
						...
						i.containedIn("url", n), i.find().then(function(e) {
							e.length > 0 && u.each(e, function(e, t) {
								var n = t.get("url"),
									r = t.get("time"),
									i = u.find(document, '.leancloud_visitors[id="' + n + '"]') || u.find(document,
		...
		r.prototype.Q = function(e) {
			...
			t.emoji = {
				...
				show: function() {
					return t.emoji.hide(), u.attr(o, "v", 1), u.removeAttr(i, "v"), r.innerHTML = h.comment, u.attr(r, "style",
						"display:block"), T(), t.preview
				},
				hide: function() {
			...
			var m = function(e) {
					...
					return u.each(n, function(e, n) {
						1 === n.nodeType && (r.indexOf(n.nodeName) > -1 && ("INPUT" === n.nodeName && "checkbox" === u.attr(n,
							"type") ? u.attr(n, "disabled", "disabled") : u.remove(t, n)), "A" === n.nodeName && i(n, "href"), u.clearAttr(
							n))
					}), t.innerHTML
				},
				y = function(e) {
			...
			var L = function(e, n, r) {
					...
					p = f ? '<a class="vnick" rel="nofollow" href="' + f + '" target="_blank" >' + e.get("nick") + "</a>" :
						...
						p + " " + l + '</div>\n                <div class="vmeta">\n                    <span class="vtime">' + c(e.get(
							"insertedAt") || e.createdAt, t.locale) + '</span>\n                    <span rid="' + (e.get("rid") || e.id) +
						'" cid="' + e.id + '" at="@' + u.escape(e.get("nick")) + '" mail="' + e.get("mail") + '" class="vat">' + t.locale
						.ctrl.reply +
						'</span>\n                </div>\n                <div class="vcontent">\n                    ' + m(e.get(
							"comment")) + "\n                </div>\n            </div>";
			...
			var j = function() {
					h.comment = "", _.comment.value = "", y(_.comment), u.attr(_.comment, "placeholder", t.placeholder), R = {},
					...
					for (var i in h)
						...
						try {
							if (R.rid) {
								...
								'<span class="num">1</span> ' + t.locale.tips.comments, L(e, u.find(t.el, ".vlist"));
							h.mail && N({
								username: h.nick,
								mail: h.mail
		...
		var a = /[&<>"'`\\]/g,
			...
			d = {
				on: function(e, t, n, r) {
					e = e.split(" ");
					for (var i = 0, o = e.length; i < o; i++) d.off(e[i], t, n, r), t.addEventListener ? t.addEventListener(e[i],
				...
				prop: function(e, t, n) {
					return void 0 !== n ? e[t] = n : "[object Object]" !== {}.toString.call(t) ? e[t] : void d.each(t, function(t,
						n) {
						e[t] = n
					})
				},
